...
class Client(Iface):
    ...
    def parImpar(self, num):
        ...
        Parameters:
         - num
        """
        self.send_parImpar(num)
        return self.recv_parImpar()

    def send_parImpar(self, num):
        self._oprot.writeMessageBegin('parImpar', TMessageType.CALL, self._seqid)
        args = parImpar_args()
        args.num = num
    ...
    def recv_parImpar(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            raise x
        result = parImpar_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "parImpar failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap = {}
        self._processMap["parImpar"] = Processor.process_parImpar
    ...
    def process_parImpar(self, seqid, iprot, oprot):
        args = parImpar_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = parImpar_result()
        try:
            result.success = self._handler.parImpar(args.num)
        ...
        oprot.writeMessageBegin("parImpar", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class parImpar_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('parImpar_args')
...
all_structs.append(parImpar_args)
parImpar_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'num', None, None, ),  # 1
)


class parImpar_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('parImpar_result')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(parImpar_result)
parImpar_result.thrift_spec = (
...
dividir_result.thrift_spec = (
    ...
    (1, TType.STRUCT, 'error', [Error, None], None, ),  # 1
)
